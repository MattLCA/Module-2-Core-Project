...
document.addEventListener("DOMContentLoaded", () => {
  ...
  loginForm.addEventListener("submit", async (event) => {
    ...
    if (!selectedRoleInput) {
      showMessage("Please select a login role.", "error");
    ...
    const role = selectedRole === "HR Manager" ? "hr" : "worker";
    ...
    try {
      ...
      if (role === "hr") {
        ...
        localStorage.setItem("hrEmployee", JSON.stringify(employee));

        localStorage.setItem("hrRole", "hr");
      }
      ...
      if (role === "worker") {
        ...
        localStorage.setItem("workerEmployee", JSON.stringify(employee));

        localStorage.setItem("workerRole", "worker");

        localStorage.setItem("workerProfile", JSON.stringify(employee));
      }
  ...
  if (forgotPasswordLink) {
    forgotPasswordLink.addEventListener("click", (event) => {
      ...
      showMessage("Please contact HR to reset your password.", "error");
    });
  }
