...
document.addEventListener(
    ...
    () => {
        ...
        (function setDateAndGreeting() {
            ...
            if (dateText) {
                ...
                dateText.textContent =
                    `${dateStr} · Here's how the team is doing today`;
            ...
            return apiFetch(
                ...
                .catch(
                    function(error) {
                        ...
                        console.error(
                            "[HR Dashboard] Failed to load dashboard:",
                            error
                        );


                        showToast(
                            "Failed to load dashboard data from the server."
                        );
        ...
        const recentEmployeesTbody =
            document.getElementById(
                "recentEmployeesTbody"
            );
        ...
        const leaveRequestsSub =
            document.getElementById(
                "leaveRequestsSub"
            );

        const leavePendingTrendText =
            document.getElementById(
        ...
        function pendingCount() {
            ...
            return leaveListEl
                .querySelectorAll(
                    '.leave-item[data-status="pending"]'
                )
                .length;
        ...
        function syncPendingCounters() {
            ...
            if (leavePendingTrendText) {
                ...
                leavePendingTrendText.textContent =
                    `${count} pending`;
            ...
            leaveListEl.addEventListener(
                ...
                async event => {
                    ...
                    try {
                        ...
                        console.log(
                            "[HR Dashboard] Sending leave decision:",
                            {
                                requestId,
                                status
                            }
                        ...
                        console.log(
                            "[HR Dashboard] Backend decision response:",
                            response
                        );
                        ...
                        console.error(
                            "[HR Dashboard] Leave decision failed:",
                            error
                        );
        ...
        const legendPresentVal =
            document.getElementById(
                "legendPresentVal"
            );

        const legendAbsentVal =
            document.getElementById(
                "legendAbsentVal"
            );

        const attendanceDateSub =
            document.getElementById(
                "attendanceDateSub"
            );
        ...
        if (notifMarkAllBtn) {
            ...
            notifMarkAllBtn.addEventListener(
                "click",
                () => {
